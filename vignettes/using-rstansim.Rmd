...
```{R}
reg_study_col <- collect(collection_name = "regression study collection", 
                         stansim_output1, stansim_output2, 
                         stansim_output3, stansim_output4)
```
...
This is a good first sign and suggests that all our datasets have converged. 
