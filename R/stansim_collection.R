...
#' type \code{stansim_collection}. \code{stansim_collection} objects are the
...
#' @param simulations A list of all simulation data other than estimated
#' values and the list of refitted data.
#'
